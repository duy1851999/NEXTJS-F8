...
export default function Footer() {
    return (
        <footer className="bg-gray-900 text-gray-300 py-8 px-6 items-center justify-between">
            <div className="max-w-8xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 px-8 md:px-16">
                {/* Cột 1 */}
                <div>
                    <h2 className="text-white text-lg font-semibold flex items-center gap-2">
                        <Image src="/f8-icon-lV2rGpF0.webp" alt="F8 Logo" width={38} height={38} className="rounded-lg w-10 h-10" /> Học Lập Trình Để Đi Làm
            ...
            <div className="flex max-w-8xl justify-between items-center mt-6 px-8 md:px-20 text-gray-400 text-sm pt-4">
